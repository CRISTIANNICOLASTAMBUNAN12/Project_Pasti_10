...
class GaleriController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->apiUrl = 'http://localhost:8710/api/galeris'; // Ganti dengan URL API Go Anda
        $this->messages = [
    ...
    public function index()
    {
        ...
        return view('admin.galeri.galeri', compact('sliders'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.galeri')->with('status', 'Category created successfully');
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.galeri.editgaleri', compact('sliders'));
        } catch (\Exception $e) {
    ...
    public function Update(Request $request, $id)
    {
        ...
        try {
            ...
            // Return redirect response
            return redirect()->route('admin.galeri')->with('status', 'Category updated successfully');
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
                'message' => $e->getMessage()
...
public function destroy($id)
{
    try {
        ...
        if ($response->getStatusCode() == 204) {
            ...
            return redirect()->route('admin.galeri')->with('status', 'Category deleted successfully');
        } else {
