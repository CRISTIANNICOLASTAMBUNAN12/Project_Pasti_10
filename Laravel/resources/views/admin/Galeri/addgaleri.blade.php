<!-- resources/views/admin/Produk/add_galeri.blade.php -->
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h1>Add Galeri</h1>
        <div class="container">
            <form method="POST" action="{{ route('admin.storegaleri') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="name" class="form-label">Galeri Name</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter galeri name" required>
                </div>
